...
import com.app2waf.Manager.ProtectionSettingManager;
import com.app2waf.Model.AV;
import com.app2waf.Model.Account;
import com.app2waf.Model.Attack;
import com.app2waf.Model.Response;
import com.app2waf.util.CustomTabsHelper;
import com.app2waf.util.SnackbarHelper;
import com.app2waf.util.UnixTime;
import com.app2waf.util.Web;
...
import static com.app2waf.util.JumpPermissionManagement.GoToSetting;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, AddNewSiteDialogFragment.addSiteDialogListener, deleteAccountDialog.deleteDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefs = getSharedPreferences("com.wafwaf", MODE_PRIVATE);
